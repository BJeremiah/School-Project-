...
// Lists every student in the teacher's class as a card with a Present/Absent toggle.
...
export default function AttendanceScreen({ token }: { token: string }) {
  ...
  const confirmRemoveStudent = (student: Student) => {
    Alert.alert(
      'Remove Student',
      `Remove ${student.first_name} ${student.last_name} from your class?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Remove',
      ...
      {isHoliday ? (
        ...
        <>
          ...
          <View style={styles.footer}>
            <GlassButton
              label={saving ? 'Saving...' : 'Submit Attendance'}
              onPress={submitAttendance}
              variant="primary"
